...
class Project( models.Model ):
    ...
    slug = models.SlugField()
    image = models.ImageField( null=True, blank=True, default="https://github.com/qaexpert/megasite/blob/81bfae605ed69bd4399b1b131408df123939a654/static/project_images", upload_to='media/project_images', verbose_name='Изображение')
